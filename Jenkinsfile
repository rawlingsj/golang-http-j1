pipeline {
    ...
    stages {
      stage('CI Build and push snapshot') {
        ...
        steps {
          dir ('/home/jenkins/go/src///golang-http-j1') {
            checkout scm
            container('go') {
              sh "make linux"
          ...
          dir ('/home/jenkins/go/src///golang-http-j1/charts/preview') {
            container('go') {
              sh "make preview"
      ...
      stage('Build Release') {
        ...
        steps {
          container('go') {
            ...
            dir ('/home/jenkins/go/src///golang-http-j1/charts/golang-http-j1') {
